...
extern GType skin_window_get_type (void);

#ifdef GTK_IS_WIDGET_CLASS
#include <gtk/gtkversion.h>
#endif
GType object_types[2];

static GType *
get_object_types (void)
{
    gint i = 0;
    object_types[i++] = skin_window_get_type ();
    object_types[i] = 0;
...
/* The output files */
const gchar *signals_filename = "./libskin.signals.new";
const gchar *hierarchy_filename = "./libskin.hierarchy.new";
const gchar *interfaces_filename = "./libskin.interfaces.new";
const gchar *prerequisites_filename = "./libskin.prerequisites.new";
const gchar *args_filename = "./libskin.args.new";
